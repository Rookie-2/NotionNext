...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SZY', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的Coder🧑‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://commandcv.tech/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,golang,博客', // 网站关键词 英文逗号隔开
